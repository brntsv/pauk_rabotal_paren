...
Go соберет и запустит временный бинарник сам, но отдельный файл в проекте не появится.
...
Так можно получить постоянный бинарник, явно задав путь для результата сборки.
